...
CameraState::CameraState( Vector3 const &position, Quaternion const &orientation, float const &fov )
	: m_position( position )
...
CameraState::CameraState( Vector3 const &position, Vector3 const &eulerAngleOrientation, float const &fov )
	: m_position( position )
