...
void Attract::Render( Camera *gameCamera ) const
{
	...
	g_theRenderer->DrawTextInBox2D( "Legends of Zelda", Vector2(0.5f, 0.6f), g_theGame->m_default_screen_bounds, 0.08f, RGBA_RED_COLOR, g_theGame->m_textBmpFont, TEXT_DRAW_SHRINK_TO_FIT );
