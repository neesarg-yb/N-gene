...
EnemyBullet::EnemyBullet( Vector2 position, float shootAtAngle, float speed )
{
...
void EnemyBullet::Render() {
	...
	// Draw Bullet
	g_theRenderer->DrawTexturedAABB( textureBounds, *bulletTexture, Vector2(0,1), Vector2(1,0), RGBA_RED_COLOR );
